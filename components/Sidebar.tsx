  ...
  return (
    <div className="h-full sticky top-0 p-6 border-r border-white/10">
      <motion.div
        ...
        className="space-y-8"
      >
        <Link href="/" className="block" aria-label="Site home">
        ...
        <div className="card p-4">
          ...
          <div className="mt-1 text-sm">
            Open to 2026 roles. Building AI+Gov index v2.
          </div>
          <div className="mt-3 flex gap-2 flex-wrap">
            <span className="px-2 py-1 text-xs rounded-full bg-accent/15 ring-1 ring-accent/30">
              Now: Taipei → DC
            </span>
            <span className="px-2 py-1 text-xs rounded-full bg-white/5 ring-1 ring-white/10">
              Writing: Thesis
            </span>
          </div>
        </div>
