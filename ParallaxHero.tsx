...
return (
<motion.header ref={ref} onMouseMove={onMove} style={{ rotateX: rx, rotateY: ry, transformStyle: "preserve-3d" }} className="card p-10 md:p-14">
<h1 className="font-display text-4xl md:text-6xl tracking-tight">What can I help with?</h1>
